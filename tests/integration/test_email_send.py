...
async def test_send_sample_email():
    ...
    if "401" in result or "403" in result or "invalid" in result.lower() or "expired" in result.lower():
        pytest.fail(
    ...
    if "422" in result and ("domain must be verified" in result.lower() or "ms42207" in result.lower()):
        pytest.fail(
